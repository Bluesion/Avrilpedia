 ...
 */
package com.illusion.avrillavigne.customlibrary.MaterialDialog.listener;
...
/**
 * A wrapper, which implements the interface {@link android.widget.AdapterView.OnItemClickListener} in
 * order to delegate the method calls to encapsulated listener of the type
 * {@link android.content.DialogInterface.OnMultiChoiceClickListener}.
 * 
 * @author Michael Rapp
 *
 * @since 1.0.0
...
public class OnMultiChoiceClickListenerWrapper extends AbstractListenerWrapper
	 ...
	 * {@link android.widget.AdapterView.OnItemClickListener} in order to delegate the method calls to
	 * encapsulated listener of the type {@link android.content.DialogInterface.OnMultiChoiceClickListener}.
	 * 
	 * @param listener
	 *            The listener, which should be encapsulated by the wrapper, as
	 *            an instance of the type {@link android.content.DialogInterface.OnMultiChoiceClickListener}
	 * @param dialog
	 *            The dialog, the listener should belong to, as an instance of
	 *            the class {@link android.app.AlertDialog}
	 * @param buttonType
