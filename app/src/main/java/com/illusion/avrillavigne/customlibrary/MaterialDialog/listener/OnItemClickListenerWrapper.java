...
public class OnItemClickListenerWrapper extends AbstractListenerWrapper
	 ...
	 * encapsulated listener of the type {@link android.content.DialogInterface.OnClickListener}.
	 * 
	 * @param listener
	 *            The listener, which should be encapsulated by the wrapper, as
	 *            an instance of the type {@link android.content.DialogInterface.OnClickListener}
	 * @param dialog
