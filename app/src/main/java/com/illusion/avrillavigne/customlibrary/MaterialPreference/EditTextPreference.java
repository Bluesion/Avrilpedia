...
/**
 * A preference, which allows to enter a text via an {@link android.widget.EditText} widget.
...
public class EditTextPreference extends AbstractDialogPreference {
	 ...
	 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.EditTextPreference}.
	 */
	public static class SavedState extends BaseSavedState {

		/**
		 * A creator, which allows to create instances of the class
		 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.EditTextPreference} from parcels.
		 */
		 ...
		 * state of an {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.EditTextPreference}. This constructor is called by
		...
		/**
		 * Creates a new data structure, which allows to store the internal
		 * state of an {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.EditTextPreference}. This constructor is used when
	...
	/**
	 * The {@link android.widget.EditText} widget, which allows the user to enter a text.
	 */
	 ...
	 * {@link android.widget.EditText} widget.
	 * 
	 * @param context
