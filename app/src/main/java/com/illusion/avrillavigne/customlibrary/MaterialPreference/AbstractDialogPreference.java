...
public abstract class AbstractDialogPreference extends Preference implements
	 ...
	 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.AbstractDialogPreference}.
	 */
	public static class SavedState extends BaseSavedState {

		/**
		 * A creator, which allows to create instances of the class
		 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.AbstractDialogPreference} from parcels.
		 */
		...
		/**
		 * True, if the dialog of the {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.AbstractDialogPreference}, whose
		...
		/**
		 * The saved state of the dialog of the {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.AbstractDialogPreference}
		 ...
		 * state of an {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.AbstractDialogPreference}. This constructor is
	 ...
	 *            {@link android.os.Bundle} or null, if the dialog should be created from
	 *            scratch
	 */
	 ...
	 *            instance of the class {@link android.content.Context}
	 */
	 ...
	 *         the class {@link android.app.Dialog} or null, if the dialog is currently not
	 *         shown
	 */
	 ...
	 *         {@link android.graphics.drawable.Drawable} or null, if no icon is used
	 */
	 ...
	 *            {@link android.graphics.drawable.Drawable} or null, if no icon should be used
	 */
