package com.illusion.avrillavigne.customlibrary.MaterialDialog;
...
import com.illusion.avrillavigne.customlibrary.MaterialDialog.listener.OnClickListenerWrapper;
import com.illusion.avrillavigne.customlibrary.MaterialDialog.listener.OnItemClickListenerWrapper;
import com.illusion.avrillavigne.customlibrary.MaterialDialog.listener.OnMultiChoiceClickListenerWrapper;
...
public class MaterialDialogBuilder extends AlertDialog.Builder {
	 ...
	 *         instance of the class {@link android.view.View}
	 */
	 ...
	 *            class {@link android.view.View}
	 * @return The parent view of the title view, which has been inflated, as an
	 *         instance of the class {@link android.view.ViewGroup}
	 */
	 ...
	 *         instance of the class {@link android.widget.TextView}
	 */
	 ...
	 *            an instance of the class {@link android.widget.TextView}
	 */
	private void showMessageTextView(final ViewGroup titleContainer,
			final TextView messageTextView) {
		messageTextView.setVisibility(View.VISIBLE);
		LayoutParams layoutParams = (LayoutParams) titleContainer
				.getLayoutParams();
	 ...
	 *            instance of the class {@link android.app.AlertDialog}
	 */
	 ...
	 *            clas {@link android.view.ViewGroup}
	 * @param titleContainer
	 *            The parent view of the title view as an instance of the class
	 *            {@link android.view.ViewGroup}
	 * @param messageTextView
	 ...
	 *            class {@link android.app.AlertDialog}
	 * @param listView
	 *            The list view, which is used to show the list items, as an
	 *            instance of the class {@link android.widget.ListView}
	 */
	...
	private void showContentContainer(final ViewGroup contentContainer,
		...
		LayoutParams titleLayoutParams = (LayoutParams) titleContainer
				.getLayoutParams();
		titleLayoutParams.bottomMargin = contentSpacing;
		titleContainer.setLayoutParams(titleLayoutParams);
		LayoutParams messageLayoutParams = (LayoutParams) messageTextView
				.getLayoutParams();
	 ...
	 *            buttons, as an instance of the class {@link android.view.ViewGroup}
	 * @param dialog
	 *            The dialog, the buttons belong to, as an instance of the class
	 *            {@link android.app.AlertDialog}
	 */
	 ...
	 *         the class {@link android.widget.Button} or null, if no button has been added
	 */
