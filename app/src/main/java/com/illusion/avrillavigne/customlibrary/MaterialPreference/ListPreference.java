...
import static com.illusion.avrillavigne.customlibrary.MaterialPreference.util.Condition.ensureNotNull;
...
public class ListPreference extends AbstractDialogPreference {
	 ...
	 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.ListPreference}.
	 */
	public static class SavedState extends BaseSavedState {

		/**
		 * A creator, which allows to create instances of the class
		 * {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.ListPreference} from parcels.
		 */
		 ...
		 * state of an {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.ListPreference}. This constructor is called by
		...
		/**
		 * Creates a new data structure, which allows to store the internal
		 * state of an {@link com.illusion.avrillavigne.customlibrary.MaterialPreference.ListPreference}. This constructor is used when
	 ...
	 *            preference, as an instance of the class {@link android.content.Context}
	 * @param attributeSet
	 *            The attribute set, which should be used to initialize the list
	 *            preferences, as an instance of the type {@link android.util.AttributeSet}
	 */
	 ...
	 *         {@link android.content.DialogInterface.OnClickListener}
	 */
