Avrilpedia (¶óºóÇÇµð¾Æ) for Android
...
AndroidMaterialPreferences, AndroidMaterialDialog
----------
Copyright (c) mrapp

> AndroidMaterialPreferences and AndroidMaterialDialog are distributed under the GNU Lesser Public License version 3.0 (GLPLv3).
